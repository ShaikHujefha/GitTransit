...
<div>
    <div class='w- screen h-screen'>
      ...
      <div class='w-1/4 relative top-52 left-28'>
        ...
        <div>
          <img src={truck} style={{marginLeft:'24%',marginTop:'5%'}}></img>
        </div>
        
        <div class='w-1/4 relative top-5' style={{marginLeft:'25%'}}>
        < p class="border-2 rounded-full h-4 w-4 ring-2 ring-[#F9C935] bg-[#F9C935]"></p>
        <p class='border border-dashed border-gray-300 w-64 ml-5 relative bottom-2'></p>
        <div class='flex flex-col relative top-4 '>
          <img src={Loc} style={{width:'4%'}}></img>
          <p class='text-[black] relative right-6'>Zirakhpur</p>
          <p class='text-[#919191] relative right-4' >29 Oct</p>
      ...
      <div class='w-1/4 relative bottom-14'style={{marginLeft:'45%'}} >
        < p class="border-2 rounded-full h-4 w-4 ring-2 relative bottom-2 ring-[#C4C4C4] bg-[#C4C4C4]"></p>
        <p class='border border-dashed border-gray-300 w-64 ml-5 relative bottom-4'></p>
        <div class='flex flex-col relative top-4 '>
      ...
      <div class='w-1/4 relative bottom-36'style={{marginLeft:'65%'}} >
        ...
        <p class='border border-dashed border-gray-300 w-56 ml-5 relative bottom-3'></p>
        <div class='flex flex-col relative top-4 '>
          <img src={locg} style={{width:'4%'}}></img>
          <p class='text-[black] relative right-6'>Zirakhpur</p>
          <p class='text-[#919191] relative right-4' >29 Oct</p>
      ...
      <div class='w-1/4 relative bottom-56'style={{marginLeft:'82%'}} >
        < p class="border-2 rounded-full h-4 w-4 ring-2 relative bottom-2 ring-[#C4C4C4] bg-[#C4C4C4]"></p>
       ...
       <p class='text-[#4B4B4B] text-sm relative bottom-36'style={{marginLeft:'80%'}}>Flat no:12,<br></br> ABCD street 12345 near by,<br></br> !@#$%^ District,<br></br> India</p>
       <p class='text-[#3B60C6] relative bottom-36' style={{marginLeft:'80%',marginTop:'1%'}}>Request address change</p>
